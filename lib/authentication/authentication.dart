...
class AuthenticationWidget extends StatelessWidget {
  const AuthenticationWidget({
    ...
    this.onQuestionTextTap, // 👈 Для перехода на регистрацию
    super.key,
  });
  ...
  final VoidCallback? onQuestionTextTap;
        ...
        children: [
          Column(
            children: [
              ...
              Container(
                child:
                    textFieldsPassword, // 👈 Сюда передаётся onSuffixIconPressed
              ),
              const SizedBox(height: 18),
              GestureDetector(
                onTap: () {},
              ...
              GestureDetector(
                onTap: onQuestionTextTap, // 👈 Переход на регистрацию
                child: Text(
                  questionText,
                  style: const TextStyle(
                    color: Colors.black,
